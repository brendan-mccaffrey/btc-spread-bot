...
'''
This is a replica of the ftx.py script
All buy and sell orders are replaced with declarations of when the buy/sell would be placed

Run this prior to running ftx.py everytime a new configuration is made
'''
...
def enter_position(client, spot_price, future_price, amount):
    ...
    # Place spot order
    print("ACTION: place limit buy order for ", spot_market, " of size ", spot_size, " at ", spot_price)
    # resp = client.place_order(spot_market, "buy", spot_price * margin_buy, spot_size, "limit", reduce_only, ioc, post_only)
    # Place future order
    print("ACTION: place limit sell order for ", future_market, " of size ", spot_size, " at ", future_price)
    ...
    print("Here is where the confirmation of orders would be")
    ...
    recordAction('EX-MARKET', 'buy', 'ex-fill-price', 'ex-fill-size', 'ex-notional-value')
    recordAction('EX-FUTURE-MARKET', 'sell', 'ex-fill-price2', 'ex-fill-size2', 'ex-notional-value2')
    ...
    celebrate(future_price / spot_price - 1)

    return monitor_position(client, .001, .001)
...
def exit_position(client, spot_price, future_price, spot_size, future_size):
    ...
    print(" Prices for exit - spot: ", spot_price, " future: ", future_price)
    print("")
    ...
    print("ACTION: place limit buy order for ", future_market, " of size ", future_size, " at ", future_price)
    ...
    print("ACTION: place limit sell order for ", spot_market, " of size ", spot_size, " at ", spot_price)
    ...
    # Log transactions to csv
    print("Recording action")
    recordAction('EX-FUTURE-MARKET', 'buy', 'ex-fill-price2', 'ex-fill-size2', 'ex-notional-value2')
    recordAction('EX-MARKET', 'sell', 'ex-fill-price', 'ex-fill-size', 'ex-notional-value')
    # recordAction(spot_market, 'buy', conf['avgFillPrice'], conf['filledSize'], conf['avgFillPrice'] * conf['filledSize'])
    # recordAction(future_market, 'sell', conf2['avgFillPrice'], conf2['filledSize'], conf2['avgFillPrice'] * conf2['filledSize'])
...
def start(myapi_key, mysubaccount_name, my_spot_market, my_future_market, myexp_date, amount):
    ...
    prices = None
    while True:
        print("Searching for opportunity..")

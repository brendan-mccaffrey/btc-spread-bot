...
class FtxClient:
    ...
    def get_price_history(self, market: str = None, resolution: int = None, start_time: int = None, end_time: int = None) -> List[dict]:
    ...
    def get_markets(self, market: str = None) -> dict:
